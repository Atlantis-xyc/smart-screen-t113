...
static lv_obj_t * init_item_view(lv_obj_t *parent){
    lv_obj_t * cont = lv_obj_create(parent);
    lv_obj_set_size(cont,760,LV_SIZE_CONTENT);
    lv_obj_add_style(cont,&com_style,LV_PART_MAIN);
...
void init_page_main(){
    ...
    lv_obj_t * img = lv_img_create(cont);
    lv_img_set_src(img, GET_IMAGE_PATH("icon_user1.png"));
    lv_obj_align(img,LV_ALIGN_LEFT_MID,59,0);
    ...
    lv_obj_align_to(item_view,info_view,LV_ALIGN_OUT_RIGHT_MID,150,0);
